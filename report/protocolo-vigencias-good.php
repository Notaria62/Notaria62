...
foreach ($p_ids as $key => $v) {
    ...
    if ($key <= 0) {
        # code...
        $poderdante .=  "en esta Notaria " . strtoupper($fullnamep) . ", identificado(a) con $cs->typeidentification número $cs->identification expedida en $cs->identificationexpedida";
    } else {
        # code...
        $poderdante .=  " y " . strtoupper($fullnamep) . ", identificado(a) con $cs->typeidentification número $cs->identification expedida en $cs->identificationexpedida";
    }
}
$apoderado = "";
if ($ap_ids == "1") {
    ...
    foreach ($ap_ids as $key => $j) {
        ...
        if ($key <= 0) {
            $apoderado .=  "" . strtoupper($fullnameap) . ", identificado(a) con $cs->typeidentification número $cs->identification expedida en $cs->identificationexpedida";
        } else {
            $apoderado .=  " y " . strtoupper($fullnameap) . ", identificado(a) con $cs->typeidentification número $cs->identification expedida en $cs->identificationexpedida";
        }
    }
}
