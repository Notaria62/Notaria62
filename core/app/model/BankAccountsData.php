...
/**
 * BankAccountsData short summary.
 *
 * BankAccountsData description.
 *
 * @version 1.0
 * @author sistemas
 */
...
{
    public static $tablename = "bankaccounts";
    ...
    public static function getAll()
    {
        ...
        return Model::many($query[0], new BankAccountsData());
    }
    ...
    public static function getById($id)
    {
        ...
        $query = Executor::doit($sql);
        return Model::one($query[0], new BankAccountsData());
    }
