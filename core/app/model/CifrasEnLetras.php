...
/*
  ...
  Ejemplos de uso:
    CifrasEnLetras::convertirPesosEnLetras(22.34) --> "veintidós euros con treinta y cuatro céntimos"
...
class CifrasEnLetras
{
  ...
  //---------------------------------------------
    ...
    */
    ...
    /*
      Convertir pesos en letras

      Ejemplos:
        CifrasEnLetras::convertirPesosEnLetras("44276598801,2",2) --> "cuatrocientos noventa y ocho mil un euros con veinte céntimos"
        CifrasEnLetras::convertirPesosEnLetras(85009) --> "ochenta y cinco mil nueve euros"
        CifrasEnLetras::convertirPesosEnLetras(10200.35) --> "diez mil doscientos euros con treinta y cinco céntimos"
    */
    public static function convertirPesosEnLetras($pesos, $numeroDecimales=2)
    {
