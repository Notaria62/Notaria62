 ...
 * @author sistemas
 */
class ActacomparecenciaData
{
    public static $tablename = "actacomparecencia";
    ...
    public static function getAll()
    {
        ...
        return Model::many($query[0], new ActacomparecenciaData());
    }
    ...
    public static function getById($id)
    {
        ...
        $query = Executor::doit($sql);
        return Model::one($query[0], new ActacomparecenciaData());
    }
