...
$(document).ready(function() {
   ...
   <div class="card">
       <div class="card-header card-header-primary">
           ...
           <p class="card-category">Se lleva un registro de los cuadres entregados y control y seguimiento de las
               cominicaciones</p>
       </div>
       <div class="card-body">
                       ...
                       <div class="col-md-12">
                           <div class="form-group bmd-form-group is-filled">
                               ...
                               <select id="txtclass" name="txtclass" class="custom-select" required>
                                   ...
                                   <option value="yellowEvent">Amarillo</option>
   ...
   <div class="modal fade" id="updateModal" role="dialog">
       <div class="modal-dialog">
           ...
           <div class="modal-content">
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-12">
                           <div class="form-group bmd-form-group is-filled">
                               ...
                               <input type="text" class="form-control" id="uptxttitle" name="uptxttitle" required
                                   value=" " />
                           </div>
                       </div>
                       <div class="col-md-12">
               ...
               <div class=" modal-footer">
                   <button type="button" name="update" id="update" class="btn btn-success btn-xs">Actualizar</button>
                   </td>
                   <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
               </div>
           </div>
