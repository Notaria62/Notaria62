...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" role="form" method="post" action="./?action=updatecashregister" id="updatecashregister">
            <div class="row">
                <div class="col-md-1">
                    <div class="form-group">
                        <label for="radicado" class="bmd-label-floating">Cuadre diario nro.</label>
                        <input type="text" class="form-control" id="radicado" name="radicado" required value="<?= $const ?>" />
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group bmd-form-group has-success">
                        <label for="created_at" class="bmd-label-floating">
                            Fecha</label>
                        <input type="text" name="created_at" id="created_at" class="form-control datepicker-here" data-timepicker="true" data-date-format="yyyy-mm-dd" data-time-format="hh:ii" placeholder="" value="<?= $created_at ?>">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control txtMounts" id="cuentaanticipos" name="cuentaanticipos" value="<?= $cuentaanticipos ?>" required />
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="cuentanotaria" class="bmd-label-floating">Cuenta notaria (SIGNO 1837)</label>
                        <input type="text" class="form-control txtMounts" id="cuentanotaria" name="cuentanotaria" value="<?= $cuentanotaria ?>" required />
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="cuentaunicanotarial" class="bmd-label-floating">Cuenta unica notarial
                            (SIGNO 1938)</label>
                        <input type="text" class="form-control txtMounts" id="cuentaunicanotarial" name="cuentaunicanotarial" value="<?= $cuentaunicanotarial ?>" required />
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="cuentaapropiacion" class="bmd-label-floating">Cuenta apropiacion
                            (SIGNO 3426)</label>
                        <input type="text" class="form-control" id="cuentaapropiacion" name="cuentaapropiacion" value="<?= $cuentaapropiacion ?>" required />
                    </div>
                </div>
                <!-- 
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control txtMounts" id="totalpagos" name="totalpagos" value="<?= $totalpagos ?>" required />
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control target txtMounts" id="cajaauxuliar" name="cajaauxuliar" value="<?= $cajaauxuliar ?>" required />
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="cajaprincipal" class="bmd-label-floating">Cajero principal</label>
                        <input type="text" class="form-control target" id="cajaprincipal" name="cajaprincipal" value="<?= $cajaprincipal ?>" required />
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="caja1erpiso" class="bmd-label-floating">Caja 1er primer</label>
                        <input type="text" class="form-control target" id="caja1erpiso" name="caja1erpiso" value="<?= $caja1erpiso ?>" required />
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="id_cashregister" name="id_cashregister" value="<?= $id_cashregister; ?>" />
                        <button type="submit" name="btnupdatecashregister" id="btnupdatecashregister" class="btn btn-success btn-xs">Actualizar</button>
