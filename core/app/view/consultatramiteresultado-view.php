...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title">Estatus de tramite en NOTARIA 62 <i class="material-icons">import_contacts</i></h4>
        ...
        ?>
            ...
            <div class="form-group col-xs-12 col-sm-12" id="DIV_message" style="display: none;">
                ...
                <div class="form-group">
                    <label for="" class="bmd-label-floating">Escriba su inquietud y su n&uacute;mero de
                        cont&aacute;cto</label>
