...
/**
 * consecutivosdecertificados short summary.
 *
 * consecutivosdecertificados description.
 *
 * @version 1.0
 * @author DigitalesWeb
 */
...
$page_title = 'Consecutivos de certificados';
...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title">Consecutivos de certificados</h4>
        <p class="card-category">Se muestra la lista de certificados reservados</p>
    </div>
    <div class="card-body">
        <div class="card-title">
            ...
            <a href="./?view=newconsecutivosdecertificados" class="btn btn-default">
                <i class="material-icons">add</i> Solicitar
            </a>
            <hr />
            <form class="form-horizontal" role="form">
                <input type="hidden" name="view" value="consecutivosdecertificados" />
                <div class="row">
                    <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                $result = ConsecutivosDeCertificadosData::getAllNumRow();
                if (count($result) > 0) :
                    ?>
...
$(document).ready(function() {
    var $url =
        '<?= "./?action=searchconsecutivoscertificados&start_at=" . $start_at . "&finish_at=" . $now; ?>';
