...
<div class="card">
    <div class="card-header card-header-primary">
        ...
        <p class="card-category">M&oacute;dulo para la creaci&oacute;n de minutas</p>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select id="ddlmemorandum" name="ddlmemorandum" required class="custom-select">
                        ...
                        <?php foreach (TemplateMemorandumData::getDigitizerAll() as $p):?>
        ...
        $(document).ready(function() {
            $("#searchp").on("submit", function(e) {
                ...
                $.get("./?action=searchdigitizertemplatememorandum", $("#searchp").serialize(),
                    function(data) {
