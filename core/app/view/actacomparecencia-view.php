...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title">Acta de comparecencia</h4>
        <p class="card-category">Se listan las cartas de acta de comparecencia</p>
    </div>
    <div class="card-body">
        <div class="card-title">
            ...
            <a href="./?view=newactacomparecencia" class="btn btn-default">
                <i class="material-icons">add</i> Crear acta de comparecencia
            </a>
            <hr />
...
$(document).ready(function() {
    var $url =
        '<?="./?action=searchactacomparecencia&start_at=".$start_at."&finish_at=".$now;?>';
