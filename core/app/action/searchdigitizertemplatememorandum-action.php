...
?>
<form class="" method="post" id="adddigitizermemorandum" action="./?action=adddigitizermemorandum" role="form">
    <div class="row">
        <div class="col-md-12">
            <h2>
                <?php echo $mystr;?>
...
function adddebtor() {
    ...
    htmldebtors =
        ...
        '</select></div></div><div class="col-md-4"><div class="form-group"><label for="identificacion' +
        nextinput +
